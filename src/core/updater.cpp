...
struct Updater::Impl
{
  ...
  [[nodiscard]] static DriverUpdateParams build_update_context(const UpdateTask& task,
                                                               const InetAddress& ip_addr,
...
DriverUpdateParams Updater::Impl::build_update_context(const UpdateTask& task,
                                                       const InetAddress& ip_addr,
                                                       std::string_view rd_type)
{
  return {
