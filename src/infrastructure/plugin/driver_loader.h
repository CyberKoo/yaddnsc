...
#ifndef YADDNSC_INFRASTRUCTURE_PLUGIN_DRIVER_LOADER_H
#define YADDNSC_INFRASTRUCTURE_PLUGIN_DRIVER_LOADER_H
...
#endif // YADDNSC_INFRASTRUCTURE_PLUGIN_DRIVER_LOADER_H
