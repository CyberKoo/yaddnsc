...
//
// Connection lifecycle and TLS are entirely internal: the caller sees one
// exchange(url, req, token) operation. Each exchange uses a fresh
...
public:
    /// Construct with the default stream factory.
