...
#ifndef YADDNSC_INFRASTRUCTURE_PROCESS_SIGNAL_WATCHER_H
#define YADDNSC_INFRASTRUCTURE_PROCESS_SIGNAL_WATCHER_H
...
#endif  // YADDNSC_INFRASTRUCTURE_PROCESS_SIGNAL_WATCHER_H
