...
[[nodiscard]] constexpr std::string_view error_name(Error e) noexcept {
    ...
    case Error::CANCELLED:            return "CANCELLED"sv;
    case Error::CONNECTION_FAILED:    return "CONNECTION_FAILED"sv;
    case Error::HEADER_PARSE_FAILED:  return "HEADER_PARSE_FAILED"sv;
    case Error::INCOMPLETE:           return "INCOMPLETE"sv;
    case Error::CONTENT_TYPE_MISMATCH: return "CONTENT_TYPE_MISMATCH"sv;
    case Error::HEADERS_TOO_LARGE:    return "HEADERS_TOO_LARGE"sv;
    case Error::BODY_TOO_LARGE:       return "BODY_TOO_LARGE"sv;
    case Error::CHUNK_PARSE_FAILED:   return "CHUNK_PARSE_FAILED"sv;
    }
    return "UNKNOWN"sv;
}
