...
private:
    ...
    static ParsedMessage parse_message(std::span<const std::uint8_t> data);
    ...
    rdata_to_string(const ResourceRecord &rr, std::span<const std::uint8_t> wire);
    ...
    [[nodiscard]] static std::string
    format_domain_name(std::span<const std::uint8_t> wire, size_t rdata_offset);
    [[nodiscard]] static std::string
    format_mx(std::span<const std::uint8_t> wire, size_t rdata_offset);
    [[nodiscard]] static std::string
    format_soa(std::span<const std::uint8_t> wire, size_t rdata_offset);
    [[nodiscard]] static std::string
    format_srv(std::span<const std::uint8_t> wire, size_t rdata_offset);
    [[nodiscard]] static std::string
    format_generic(std::span<const std::uint8_t> rdata);

    // ── EDNS0 parsing ──
    static std::optional<EdnsInfo> parse_edns(const ResourceRecord &rr);
