...
public:
    ...
    QueryBuilder& add_question(std::string_view qname,
                                RecordType qtype,
    ...
    QueryBuilder& add_question_raw_qclass(std::string_view qname,
                                            RecordType qtype,
    ...
    QueryBuilder& add_edns(std::uint16_t udp_payload_size,
