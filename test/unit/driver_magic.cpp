...
//   - The value is the expected ASCII encoding of "YADDNSC\0\0".
...
TEST(DriverMagicTest, Value_Matches_AsciiEncoding) {
    // "YADDNSC\0\0" in big-endian: Y=0x59, A=0x41, D=0x44, D=0x44, N=0x4E, S=0x53, C=0x43, \0=0x00, \0=0x00
    // Packed as uint64_t: 0x5941444E53430000
    EXPECT_EQ(YADDNSC_DRIVER_MAGIC, 0x5941444E53430000ULL);
}
